        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if($page == "Dashboard") echo "active";?>" aria-current="page" href="../dashboard/index.php">
                            <i class="icon">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if($page == "Deposit") echo "active";?>" data-bs-toggle="collapse" href="#sidebar-auth" role="button" aria-expanded="false" aria-controls="sidebar-user">
                            ...
                            <span class="item-name">Deposit Saldo</span>
                            <i class="right-icon">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-auth" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="../dashboard/deposit_otomatis.php">
                                    <i class="icon">
                                    ...
                                    <span class="item-name">Otomatis</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="../dashboard/deposit_manual.php">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="../dashboard/riwayat_deposit.php">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <span class="item-name">Riwayat Deposit</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if($page == "Order") echo "active";?>" data-bs-toggle="collapse" href="#sidebar-special" role="button" aria-expanded="false" aria-controls="sidebar-special">
                            <i class="icon">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-special" data-bs-parent="#sidebar-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="../dashboard/history_order.php">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <i class="sidenav-mini-icon"> R </i>
                                    <span class="item-name">History Order</span>
                                </a>
                            </li>
                        </ul>
                    </li>   
                    <li class="nav-item">
                        <a class="nav-link" href="../dashboard/tiket.php">
                            <i class="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if($page == "Layanan") echo "active";?>" href="../dashboard/daftar_layanan.php">
                            <i class="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="item-name">Daftar Layanan</span>
                        </a>
                    </li>
                </ul>
