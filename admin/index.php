...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
      ...
      <title>Meji SMM | Dashboard Admin</title>
               ...
               <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="700">
                  <div class="card-body">
                     <div class="progress-widget">
                        ...
                        <?php
                        $sum_today_trx = mysqli_query($conn, "SELECT SUM(total_harga) as total FROM orderd WHERE date = DATE(NOW())");
                        $fetch = mysqli_fetch_array($sum_today_trx);
                        ?>
                        <div class="progress-detail">
                           <p  class="mb-2">Transaksi Hari Ini</p>
                           <h4 class="counter"><?php echo "Rp " . number_format($fetch['total'],2,',','.')?></h4>
                        </div>
                     </div>
                  </div>
               </li>
               <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="800">
                  <div class="card-body">
                     <div class="progress-widget">
                        ...
                        <?php
                        $sum_today_depo = mysqli_query($conn, "SELECT SUM(total_didapat) as total FROM deposit WHERE date = DATE(NOW())");
                        $data = mysqli_fetch_array($sum_today_depo);
                        ?>
                         <div class="progress-detail">
                           <p  class="mb-2">Deposit Hari Ini</p>
                           <h4 class="counter"><?php echo "Rp " . number_format($data['total'],2,',','.')?></h4>
                        </div>
                     </div>
                  </div>
               </li>
               <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="900">
                  <div class="card-body">
                     <div class="progress-widget">
                        ...
                        <?php
                        $total_trx = mysqli_query($conn, "SELECT SUM(total_harga) as total FROM orderd");
                        $result = mysqli_fetch_array($total_trx);
                        ?>
                        <div class="progress-detail">
                           <p  class="mb-2">Total Transaksi</p>
                           <h4 class="counter"><?php echo "Rp " . number_format($result['total'],2,',','.')?></h4>
                        </div>
                     </div>
                  </div>
               </li>
               <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="1000">
                  <div class="card-body">
                     <div class="progress-widget">
                        ...
                        <?php
                        $total_depo = mysqli_query($conn, "SELECT SUM(total_didapat) as total FROM deposit where status= 'SUCCESS'");
                        $hsil = mysqli_fetch_array($total_depo);
                        ?>
                        <div class="progress-detail">
                           <p  class="mb-2">Total Deposit</p>
                           <h4 class="counter"><?php echo "Rp " . number_format($hsil['total'],2,',','.')?></h4>
                        </div>
                     </div>
                  </div>
               </li>
               <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="1100">
                  <div class="card-body">
                     <div class="progress-widget">
                        ...
                        $user = mysqli_num_rows($total_user);
                        ?>
                        <div class="progress-detail">
      ...
      <footer class="footer">
          <div class="footer-body">
              ...
              <div class="right-panel">
                  ©<script>document.write(new Date().getFullYear())</script> Meji SMM , Made with
